      ...
      <div className="p-4 border-b">
        ...
        <div className="mt-4 space-y-2 text-sm">
          ...
          <div>
            ...
            <select id="position" value={positionFilter} onChange={e => { posthog?.capture('filter_applied', { filter: 'poder', value: e.target.value }); setPositionFilter(e.target.value); }} className="w-full p-2 border rounded bg-white">
